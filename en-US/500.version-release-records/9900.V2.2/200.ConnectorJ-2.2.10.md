...
* Fixed an issue where the ResultSet.close() interface did not implement the cursor closing logic when using a refcursor in Oracle-compatible mode. As a result, cursors in OceanBase Database might not be released in time in some cases.
