...
* `getArray`
  ...
  This method retrieves the content of an array of the default Java Database Connectivity (JDBC) type. If it retrieves an array of objects, `getArray` determines the type by using the default type mapping of the database connection object.
...
* `free()`
  ...
  This method releases the memory space.
