|slug|use-the-array-and-struct-classes|
|---|---|

Use ARRAY and STRUCT classes 
=================================================
#docslug#/connector-j/connector-j/V2.2.6/use-the-array-and-struct-classes
ARRAY and STRUCT classes belong to the same collection class and are usually used together. 

ARRAY descriptor 
----------------------------------

To create and use an `ARRAY` object, you need to specify a descriptor, that is, an instance of the `oracle.sql.ArrayDescriptor` class. For any number of `ARRAY` objects corresponding to the same SQL type, only one `ArrayDescriptor` object is required. 
...
* `getDescriptor`
  ...
  This method returns an `ArrayDescriptor` object that describes the array type.
...
* `getArray`
  ...
  This method retrieves the content of an array of the default JDBC type. If it retrieves an array of objects, `getArray` determines the type by using the default type mapping of database connection objects.
  

* `getOracleArray`

  This method is the same as `getArray`, except that it retrieves elements in the `oracle.sql*` format.
...
* `getBaseType`
  ...
  This method returns the SQL type code of the array elements.
...
* `getBaseTypeName`
  ...
  This method returns the SQL type name of the array elements.
...
* `getSQLTypeName`
  ...
  This method returns the standard SQL type name for the entire array. This method is an Oracle extension.
...
* `getResultSet`
  ...
  This method materializes array elements into a result set.
...
* `getJavaSQLConnection`
  ...
  This method returns the connection instance associated with this array.
